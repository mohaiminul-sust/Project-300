...
public class Life_Move extends Collition{
       ...
       public Random rand;
            ...
            for(int i=1;i<probable_position.length;++i){
                ...
                for(int i=1;i<probable_position.length;++i){
                    if(i>1  && i<7){
                      ...
                      int retio_of_F_and_obs[]=new int[4];
                      retio_of_F_and_obs[0]=make_retio_of_food_and_obs(0,k, food_position, obs_position);
                      retio_of_F_and_obs[1]=make_retio_of_food_and_obs(1,k, food_position, obs_position);
                      retio_of_F_and_obs[2]=make_retio_of_food_and_obs(2,k, food_position, obs_position);
                      retio_of_F_and_obs[3]=make_retio_of_food_and_obs(3,k, food_position, obs_position);
        ...
        public int make_retio_of_food_and_obs(int direction,int k,int[] food_position,int[] obs_position){
