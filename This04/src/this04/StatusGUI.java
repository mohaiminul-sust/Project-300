...
public class StatusGUI extends javax.swing.JFrame {
    ...
    public int update(int total_thread,int[] thread_position,int latest_gen,int total_food,int total_poison){
        jLabel6.setText(""+total_thread);
        jLabel7.setText(""+count_alive_thread(thread_position));
        jLabel8.setText(""+latest_gen);
        jLabel9.setText(""+total_food);
        jLabel10.setText(""+total_poison);
        
        return count_alive_thread(thread_position);
    }
    public int count_alive_thread(int[] thread_position){
        int alive_thread=0;
        for(int i=0;i<thread_position.length;i++){
            if(thread_position[i]>0){
                ++alive_thread;
                if(i>20 && thread_position[i]==0){
                    return alive_thread;
                }
            }
        }
